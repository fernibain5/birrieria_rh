...
export const timeUnitFormSteps: FormStep[] = [
  {
    title: 'Información del Contrato',
    description: 'Seleccione el propietario, sucursal e ingrese las fechas de inicio y fin del contrato por unidad de tiempo',
    fields: [
      {
        name: 'ownerKey',
